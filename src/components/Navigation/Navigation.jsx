        ...
        {loggedIn ? (
          <>
            ...
            <div className={`menu__box ${isClicked ? 'menu__box_open' : ''}`}>
              <NavLink exact="true" to='/' className='menu__film-link link' activeclassname="active" onClick={handleMenuClose}>
                Главная
              </NavLink>
              <NavLink to='/movies'  className='menu__film-link link'  activeclassname="active" onClick={handleMenuClose}>
                Фильмы
              </NavLink>
              <NavLink to='/saved-movies'  className='menu__film-link link' activeclassname="active" onClick={handleMenuClose}>
                Сохраненные фильмы
              </NavLink>
